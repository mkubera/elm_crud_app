...
var $author$project$Api$Cmds$getUsers = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Msg$GotUsers, $author$project$Api$Decoders$usersDecoder),
		url: '/api/users'
	});
var $author$project$Main$initialModel = function (_v0) {
	return _Utils_Tuple2(
		{enteredUsername: '', errorMessage: $elm$core$Maybe$Nothing, users: _List_Nil},
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
	...
	return $elm$http$Http$request(
		{
			...
			expect: A2($elm$http$Http$expectJson, $author$project$Msg$GotDeletedUser, $author$project$Api$Decoders$userIdDecoder),
			headers: _List_Nil,
			method: 'DELETE',
...
var $author$project$Api$Cmds$postNewUser = $elm$http$Http$post(
	{
		body: $elm$http$Http$jsonBody($author$project$Api$Encoders$newUserEncoder),
		expect: A2($elm$http$Http$expectJson, $author$project$Msg$GotCreatedUser, $author$project$Api$Decoders$userDecoder),
		url: '/api/users/create'
	});
var $author$project$Msg$GotUpdatedUser = function (a) {
	return {$: 'GotUpdatedUser', a: a};
};
	...
	return $elm$http$Http$request(
		{
			...
			expect: A2($elm$http$Http$expectJson, $author$project$Msg$GotUpdatedUser, $author$project$Api$Decoders$userDecoder),
			headers: _List_Nil,
			method: 'PUT',
			timeout: $elm$core$Maybe$Nothing,
			tracker: $elm$core$Maybe$Nothing,
...
var $author$project$Msg$GotVerifiedUser = function (a) {
	return {$: 'GotVerifiedUser', a: a};
};
var $author$project$Api$Cmds$verifyUser = function (userId) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$Msg$GotVerifiedUser, $author$project$Api$Decoders$userIdDecoder),
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								errorMessage: $elm$core$Maybe$Just($author$project$Model$UsersFetch)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'GotCreatedUser':
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								errorMessage: $elm$core$Maybe$Just($author$project$Model$UserCreate)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'GotUpdatedUser':
				...
				if (result.$ === 'Ok') {
					...
					var newUsers = A2(
						$elm$core$List$map,
						function (u) {
							return _Utils_eq(u.id, id) ? _Utils_update(
								u,
								{isEditable: false, name: name}) : u;
						},
						model.users);
					return _Utils_Tuple2(
						_Utils_update(
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								errorMessage: $elm$core$Maybe$Just($author$project$Model$UserUpdate)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'GotDeletedUser':
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								errorMessage: $elm$core$Maybe$Just($author$project$Model$UserDelete)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'GotVerifiedUser':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var userId = result.a;
					var newUsers = A2(
						$elm$core$List$map,
						function (u) {
							return _Utils_eq(u.id, userId) ? _Utils_update(
								u,
								{verified: true}) : u;
						},
						model.users);
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								errorMessage: $elm$core$Maybe$Just($author$project$Model$UserVerify)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'AddUser':
			...
			case 'MakeEditable':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							enteredUsername: A2($author$project$Main$chosenUser, userId, model.users).name,
							users: A2(
								$elm$core$List$map,
								function (u) {
									return _Utils_eq(u.id, userId) ? _Utils_update(
			...
			case 'UpdateUser':
				var userId = msg.a;
				var user = A2($author$project$Main$chosenUser, userId, model.users);
				var editedUser = A3($author$project$Model$FetchedUser, userId, model.enteredUsername, user.verified);
				return _Utils_Tuple2(
					model,
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
...
var $author$project$Msg$CloseErrorMessage = {$: 'CloseErrorMessage'};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Background$color($author$project$Main$color.errMsgBg)
				]),
			_List_fromArray(
				[
					A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$Border$color($author$project$Main$color.gray100),
										$mdgriffith$elm_ui$Element$Font$color($author$project$Main$color.gray100)
									]))
							]),
								...
								return A2(
									...
									_List_fromArray(
										[
											...
											$mdgriffith$elm_ui$Element$Background$color($author$project$Main$color.white),
											A2($mdgriffith$elm_ui$Element$Border$glow, $author$project$Main$color.gray245, 5),
											$mdgriffith$elm_ui$Element$mouseOver(
											_List_fromArray(
												[
													$mdgriffith$elm_ui$Element$Border$color(
										...
										if (_v0) {
											return _List_fromArray(
												[
													...
													{
														label: $mdgriffith$elm_ui$Element$Input$labelHidden('Entered username'),
														onChange: $author$project$Msg$StoreEnteredUsername,
													...
													$elm$core$Maybe$Just(
														$author$project$Msg$UpdateUser(u.id)),
													'yes'),
													A3(
													$author$project$Main$viewBtn,
													_List_fromArray(
													...
													$elm$core$Maybe$Just(
														$author$project$Msg$CloseEdit(u.id)),
													'no')
												]);
										} else {
											return _List_fromArray(
												[
													...
													_List_fromArray(
														[$mdgriffith$elm_ui$Element$centerX]),
													$elm$core$Maybe$Just(
														$author$project$Msg$MakeEditable(u.id)),
													u.name),
													A3(
													$author$project$Main$viewBtn,
													_List_fromArray(
													...
													$elm$core$Maybe$Just(
														$author$project$Msg$DeleteUser(u.id)),
													'remove'),
													function () {
													var _v1 = u.verified;
													if (_v1) {
														return A2(
															...
															_List_fromArray(
																[
																	...
																	$mdgriffith$elm_ui$Element$Border$rounded(5),
																	$mdgriffith$elm_ui$Element$padding(5),
																	$mdgriffith$elm_ui$Element$Font$color($author$project$Main$color.gray150),
																	$mdgriffith$elm_ui$Element$Border$color($author$project$Main$color.gray150)
																]),
														...
														return A3(
															...
															$elm$core$Maybe$Just(
																$author$project$Msg$VerifyUser(u.id)),
															'approve');
													}
												}()
												]);
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{init: $author$project$Main$initialModel, subscriptions: $author$project$Main$subs, update: $author$project$Main$update, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Msg.Msg","aliases":{"Model.FetchedUser":{"args":[],"type":"{ id : Model.UserId, name : String.String, verified : Basics.Bool }"},"Model.FetchedUsers":{"args":[],"type":"List.List Model.FetchedUser"},"Model.UserId":{"args":[],"type":"String.String"}},"unions":{"Msg.Msg":{"args":[],"tags":{"GotUsers":["Result.Result Http.Error Model.FetchedUsers"],"GotCreatedUser":["Result.Result Http.Error Model.FetchedUser"],"GotUpdatedUser":["Result.Result Http.Error Model.FetchedUser"],"GotDeletedUser":["Result.Result Http.Error Model.UserId"],"GotVerifiedUser":["Result.Result Http.Error Model.UserId"],"AddUser":[],"MakeEditable":["Model.UserId"],"StoreEnteredUsername":["String.String"],"CloseEdit":["Model.UserId"],"UpdateUser":["Model.UserId"],"DeleteUser":["Model.UserId"],"VerifyUser":["Model.UserId"],"CloseErrorMessage":[]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));